...
## Installation
Go Python Official Website: https://www.python.org/ Download and Install.(If you are using Linux(Ubuntu/RedHat...) or Mac, there is no need to do so, because python is a build-in software on these platform.)
